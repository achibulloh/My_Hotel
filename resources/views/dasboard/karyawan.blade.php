...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Management Karyawan</h1>
            ...
            <div class="row">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#tambahadmin" class="btn btn-primary"><i class="far fa-plus-square"></i> Tambah Karyawan</button>
                            ...
                            <div class="modal fade" id="tambahadmin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('tambah_karyawan') }}" method="POST">
                                        ...
                                        <input type="text" name="role" id="role" value="karyawan" hidden>
                                    </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cencel</button>
                                            <button class="btn btn-primary" type="submit" name="submit">Tambah Karyawan Sekarang</button>
                                        </div>
                                    </form>
                                </div>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($karyawan as $items)
                                        <tr>
                                            ...
                                            <td>{{ $items->role }}</td>
                                            <td align=center>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#lihatkaryawan{{ $items->id }}" class="btn btn-secondary"><i class="fas fa-eye"></i></button>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#editkaryawan{{ $items->id }}" class="btn btn-primary"><i class="far fa-edit"></i></button>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#hapuskaryawan{{ $items->id }}" class="btn btn-danger"><i class="far fa-trash-alt"></i></button>
                                                {{-- Modal Lihat --}}
                                                    <div class="modal fade" id="lihatkaryawan{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            @csrf
                                                            <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Lhat Data Karyawan </h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                        <div class="input-group mb-3">
                                                                ...
                                                                <div class="modal-footer">
                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#editkaryawan{{ $items->id }}" class="btn btn-danger">Ubah Data Sekarang</button>
                                                ...
                                                {{-- End Modal Lihat --}}
                                                {{-- Modal Edit Data --}}
                                                    <div class="modal fade" id="editkaryawan{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            @csrf
                                                            <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                <form action="{{ route('update_karyawan',$items->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                                        <div class="input-group mb-3">
                                                ...
                                                {{-- End Modal Edit Data --}}
                                                {{-- Modal Hapus --}}
                                                    <div class="modal fade" id="hapuskaryawan{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cencel</button>
                                                                <form action="{{ route('hapus_karyawan', $items->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
