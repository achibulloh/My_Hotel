            ...
            <div class="row">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#tambahmanager" class="btn btn-primary"><i class="far fa-plus-square"></i> Tambah User</button>
                        {{-- Modal Tambah User --}}
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('tambah_user') }}" method="POST">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-primary" type="submit" name="submit">Tambah User Sekarang</button>
                                        </div>
                                    </form>
                                </div>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($user as $items)
                                        <tr>
                                            ...
                                            <td>{{ $items->role }}</td>
                                            <td align=center>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#lihatuser{{ $items->id }}" class="btn btn-secondary"><i class="fas fa-eye"></i></button>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#edituser{{ $items->id }}" class="btn btn-primary"><i class="far fa-edit"></i></button>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#hapus_user{{ $items->id }}" class="btn btn-danger"><i class="far fa-trash-alt"></i></button>
                                                {{-- Modal Lihat --}}
                                                    <div class="modal fade" id="lihatuser{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            @csrf
                                                            <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Lhat Data User </h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                        <div class="input-group mb-3">
                                                                ...
                                                                <div class="modal-footer">
                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#edituser{{ $items->id }}" class="btn btn-danger">Ubah Data Sekarang</button>
                                                ...
                                                {{-- End Modal Lihat --}}
                                                {{-- Modal Edit Data --}}
                                                    <div class="modal fade" id="edituser{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            @csrf
                                                            <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                <form action="{{ route('update_user',$items->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                                        <div class="input-group mb-3">
                                                ...
                                                {{-- Bug Bagian Modal Di Manager Sama Admin --}}
                                                    <div class="modal fade" id="hapus_user{{ $items->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cencel</button>
                                                                    <form action="{{ route('hapus_user', $items->id)}}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
